 ...
 *	   S128   token = "Hello_World"_gID;	// C identifier tokens as numbers - radix 37, 63
 * 
...
STR _CXToStr(const Gdz<TN>& Num, U32 Radix, S32 DBlk, U32 Flags, const char* iSep, const char* iWrap, STR hOut) {
	_CX U32 BufMax = 512; static char buf[BufMax * 2], DigBuf[BufMax];
	DBlk = DBlk < 1 ? TN*32 : DBlk; Radix = min(max(Radix, (U32)2), (U32)64); // Blk > 0, Radix: 2-64,  //if hOut, size>=256
	...
	for( *DigBuf = '0'; Acc != 0 && DigCnt < BufMax * 2; DigBuf[DigCnt++] = gTblBit[Acc.DivV32(Radix, Acc)][4]);
...
_CX GdzL GdzUdt(const char* str, std::size_t len, U32 radix) {  // general radix decode
	GdzL RVal = 0; S32 skip = 0, sgn = (len > 0 && str[0] == '-') ? ++skip : 0; U32 v = 0;
	if (radix < 2 || radix > 64) return RVal; // Return zero if radix not valid

	for (std::size_t i = skip; i < len; ++i) {
		if ((v = (U32) gTblBit[(U8) str[i]][5]) > 36 && radix > 10 && radix < 38) v -= 27;
		if (v >= radix) ++skip; // Skip invalid / formatting characters
		else { RVal *= radix; RVal.data[0] += v; }
	}
	return sgn ? RVal.neg() : RVal;
}
#define mOpUDT( name, radix ) _CX GdzL operator"" name (const char* str, std::size_t len) {	return GdzUdt( str, len, radix ); }
mOpUDT(_g2, 2) mOpUDT(_g8, 8) mOpUDT(_g10, 10) mOpUDT(_g16, 16) mOpUDT(_gID, 37) mOpUDT(_gIDX, 63) //encode as c++ identifier gID, gIDX
#undef mOpUDT


mNotCreate(extern) GdzTxt<Gdz<16>> GdzT;
mNotCreate(extern) S8 gTblBit[256][6] mCreate( = { //0:cnt 1:lsb 2:msb 3:flp 4:encode 5:decode - using:"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz@"
{0, -1, -1, 0, 48, -1}, {1, 0, 0, -128, 49, -1}, {1, 1, 1, 64, 50, -1}, {2, 0, 1, -64, 51, -1}, {1, 2, 2, 32, 52, -1}, {2, 0, 2, -96, 53, -1}, {2, 1, 2, 96, 54, -1}, {3, 0, 2, -32, 55, -1},
{1, 3, 3, 16, 56, -1}, {2, 0, 3, -112, 57, -1}, {2, 1, 3, 80, 65, -1}, {3, 0, 3, -48, 66, -1}, {2, 2, 3, 48, 67, -1}, {3, 0, 3, -80, 68, -1}, {3, 1, 3, 112, 69, -1}, {4, 0, 3, -16, 70, -1},
{1, 4, 4, 8, 71, -1}, {2, 0, 4, -120, 72, -1}, {2, 1, 4, 72, 73, -1}, {3, 0, 4, -56, 74, -1}, {2, 2, 4, 40, 75, -1}, {3, 0, 4, -88, 76, -1}, {3, 1, 4, 104, 77, -1}, {4, 0, 4, -24, 78, -1},
{2, 3, 4, 24, 79, -1}, {3, 0, 4, -104, 80, -1}, {3, 1, 4, 88, 81, -1}, {4, 0, 4, -40, 82, -1}, {3, 2, 4, 56, 83, -1}, {4, 0, 4, -72, 84, -1}, {4, 1, 4, 120, 85, -1}, {5, 0, 4, -8, 86, -1},
